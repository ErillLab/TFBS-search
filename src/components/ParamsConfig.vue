...
<!-- <template>
  <div class="section-block params-config">

    <h2>Pipeline Parameters</h2>

    <div class="upload-block">
      <label class="label">Pseudocount:</label>
      <input 
        type="number" 
        step="0.001" 
        v-model.number="pseudocount"
    ...
    <div class="upload-block">
      <label class="label">Threshold Method:</label>
      <select v-model="thresholdMethod" class="input-text">
        <option value="direct">Direct (raw score)</option>
        <option value="fpr">False Positive Rate (FPR)</option>
        <option value="fnr">False Negative Rate (FNR)</option>
        <option value="balanced">Balanced</option>
    ...
    <div v-if="showThresholdValue" class="upload-block">
    ...
    <div class="upload-block">
      ...
      <input
        type="text"
        placeholder="null or JSON dictionary"
        v-model="background"
        class="input-text"
      />
    </div>
    ...
    <div class="upload-block">
      <label class="label">
        <input type="checkbox" v-model="integration_log" />
        Enable Integration Log
      </label>
    </div>

    <h3>Regulatory Window</h3>

    <div class="upload-block margin-row">
      <label class="label">Region Range:</label>

      <span class="range-label">
        [+{{ marginDownstream }}, -{{ marginUpstream }}]
      </span>
    ...
    <div v-if="inferOperons" class="upload-block">
      <label class="label">Max Operon Distance:</label>
      <input 
        type="number" 
        v-model.number="max_distance_operon"
        class="input-text"
